...
const rs = __importStar(require("./remoteService"));
//GET/transcripts/:id
...
async function getGrade(studentID, course) {
    return rs.remoteGet(`/transcripts/${studentID}/${course}`);
}
//GET/studentids?name=string
async function getStudentIDs(studentName) {
...
async function deleteTranscript(studentID) {
